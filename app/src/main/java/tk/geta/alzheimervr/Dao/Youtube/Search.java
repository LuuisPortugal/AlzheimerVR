...
public class Search extends AsyncTask<Void, Integer, SearchListResponse> {
    ...
    private OnPostSearchExecute onPostSearchExecuteListener;
    ...
    protected void onPostExecute(SearchListResponse searchListResponse) {
        if(onPostSearchExecuteListener != null)
            onPostSearchExecuteListener.onPostSearchExecuteListener(searchMethodType, searchListResponse);
    ...
    public Search setOnPostExecuteListener(OnPostSearchExecute onPostSearchExecuteListener) {
        this.onPostSearchExecuteListener = onPostSearchExecuteListener;
        return this;
    }
}